          ...
          {isResellerPanelOpen && (
            ...
            >
              ...
              <div className="pt-2 border-t border-neutral-900/60">
                <button
                  onClick={() => {
                    setIsResellerPanelOpen(false);
                    setIsAdminModalOpen(true);
                  }}
                  className="w-full py-2 px-3 rounded bg-accent-orange/15 hover:bg-accent-orange/25 border border-accent-orange/40 text-accent-orange font-mono text-xs font-semibold tracking-wider font-bold uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer transition-all"
                >
                  <Cpu size={12} />
                  Launch Admin Door (apextuning2026)
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-12 border-b border-neutral-900">
            ...
            <div className="md:col-span-3 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs font-semibold font-mono font-medium">
                ...
                <button onClick={() => setIsAdminModalOpen(true)} className="text-[#FF5F1F] hover:underline text-left uppercase transition-colors font-bold cursor-pointer">Admin Gate</button>
              </div>
            </div>
